...
pcall(
    function()
        game.StarterGui:SetCore(
            ...
            {
                Text = "Loading the GUI.Bitch wait..",
            ...
            if queued == false then
                ...
                if syn then
                    syn.queue_on_teleport(
                        crossServerSettings ..
                            " loadstring(game:HttpGet('https://raw.githubusercontent.com/JoahKills/Jailbricked/master/Jailbricked.txt'))()"
                    )
                else
                    queue_on_teleport(
                        crossServerSettings ..
